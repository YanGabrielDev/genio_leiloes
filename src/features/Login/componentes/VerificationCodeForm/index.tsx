...
import { usePostVerifyEmailUser } from "@/hooks/usePostVerifyEmailUser";
...
export const VerificationCodeForm = ({ email, onSuccess, onResendCode }: VerificationCodeFormProps) => {
    const form = useFormContext();
    const [isLoading, setIsLoading] = useState(false);
    const [isResending, setIsResending] = useState(false);
    const [code, setCode] = useState<number>()
    const { mutateAsync: verifyEmailUser } = usePostVerifyEmailUser()
