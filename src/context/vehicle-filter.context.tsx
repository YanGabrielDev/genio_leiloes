...
interface VehicleFilterContextType {
  ...
  setVehicleFiltersState: (state: VehicleFiltersState) => void;
...
export const VehicleFilterContext = createContext<VehicleFilterContextType>(initialVehicleFilterContext);
...
export const VehicleFilterProvider = ({ children }: VehicleFilterProviderProps) => {
  const [vehicleFiltersState, setVehicleFiltersState] = useState<VehicleFiltersState>(initialVehicleFiltersState);
  ...
  return (
    <VehicleFilterContext.Provider value={{ vehicleFiltersState, setVehicleFiltersState /*, updateVehicleFilter */ }}>
      {children}
...
export const useVehicleFilters = () => {
  ...
  if (context === undefined) {
    throw new Error("useVehicleFilters must be used within a VehicleFilterProvider");
  }
  return context;
};